...
public partial class OldWeapon : AnimatedEntity
{
	/// <summary>
	/// The View Model's entity, only accessible clientside.
	/// </summary>
	public OldWeaponViewmodel ViewModelEntity { get; protected set; }
	...
	/// <summary>
	/// Called on the server and the owning client when your gun shoots.
	/// </summary>
	...
	public void CreateViewModel()
	{
		...
		var vm = new OldWeaponViewmodel( this );
